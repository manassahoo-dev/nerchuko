import { CloudUploadOutlined, HomeOutlined, ToolOutlined, UnorderedListOutlined, UserOutlined } from '@ant-design/icons';
...
export const menus = [
    ...
    { link: '/admin/upload', name: 'Upload', icon: <CloudUploadOutlined />, role: 'ADMIN' },
